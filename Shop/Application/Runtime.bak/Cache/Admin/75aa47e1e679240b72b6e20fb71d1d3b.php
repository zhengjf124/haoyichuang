...
-->                                
                                ...
                                <tr>
                                    <td>一级分销奖金:</td>
                                    <td>
                                        <input type="text" value="<?php echo ($goodsInfo["once_distribution_price"]); ?>" name="once_distribution_price   " class="form-control" style="width:150px;" onkeyup="this.value=this.value.replace(/[^\d.]/g,'')" onpaste="this.value=this.value.replace(/[^\d.]/g,'')" />
                                        <span id="once_distribution_price" style="color:#F00; display:none;"></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>二级分销奖金:</td>
                                    <td>
                                        <input type="text" value="<?php echo ($goodsInfo["second_distribution_price"]); ?>" name="second_distribution_price" class="form-control" style="width:150px;" onkeyup="this.value=this.value.replace(/[^\d.]/g,'')" onpaste="this.value=this.value.replace(/[^\d.]/g,'')" />
                                        <span id="second_distribution_price" style="color:#F00; display:none;"></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>三级分销奖金:</td>
                                    <td>
                                        <input type="text" value="<?php echo ($goodsInfo["third_distribution_price"]); ?>" name="third_distribution_price" class="form-control" style="width:150px;" onkeyup="this.value=this.value.replace(/[^\d.]/g,'')" onpaste="this.value=this.value.replace(/[^\d.]/g,'')" />
                                        <span id="third_distribution_price" style="color:#F00; display:none;"></span>
                                    </td>
                                </tr>
                                <!--<tr>-->
                                    <!--<td>成本价:</td>-->
                                ...
                                <tr>
	                                ...
	                                <!--<input type="checkbox" checked="checked" value="<?php echo ($goodsInfo["is_free_shipping"]); ?>" name="is_free_shipping"/> 包邮&nbsp;&nbsp;-->
                                        ...
                                        <input type="checkbox" checked="checked" value="<?php echo ($goodsInfo["is_new"]); ?>" name="is_new"/>特价&nbsp;&nbsp;
                                        ...
                                        <select name="gtype">
                                            ...
                                            <option style="display: none;" value="2" <?php if(($goodsInfo["gtype"]) == "2"): ?>selected<?php endif; ?> >限时抢购</option>
                                        </select>
                                    </td>
                                </tr>
