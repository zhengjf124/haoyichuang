        ...
        <?php if(is_array($cart_list)): $i = 0; $__LIST__ = $cart_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                <div class="left_img">
                    <div class="check_img" data-id="<?php echo ($vo["id"]); ?>">
                        <input name="" type="checkbox" cartlevel='2' class="check" style="display: none;">
                    </div>
                    <div class="img_box"><a href="<?php echo U('Index/cont',array('gid'=>$vo['id']));?>"><img
                            src="<?php echo ($vo["goods_img"]); ?>"></a></div>
                </div>
                <div class="right_tex">
                    <a href="<?php echo U('Index/cont',array('gid'=>$vo['id']));?>"><h1><?php echo ($vo["goods_name"]); ?></h1></a>
