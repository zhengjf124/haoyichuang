...
(function ($) {      
	...
	function resetIndex(){
        ...
        function CreateDateUI(){              	        	
            var str = ''+
                '<div class="weui_mask_transparent" style="z-index:10"></div>'+                
                '<div id="datePage" class="page c-float-popWrap confirmMode show">'+
	                '<div class="c-float-modePop">'+
	                	'<div class="warnMsg">弹窗标题</div>'+
	                    '<section>'+                        
	                    ...
	                    '</section>'+	                
		                '<div class="doBtn">'+
		                	'<button class="cancel" id="datecancle">取 消</button>'+
		                	'<button class="ok" id="dateconfirm">确 定</button>'+
		                '</div>'+
		            '</div>'+
                '</div>';
            $("#datePlugin").html(str);
